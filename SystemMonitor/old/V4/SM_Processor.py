...
#----------------------------------------------------------#
sql_list = [] # empty list
sql_prefix  = "INSERT INTO tb_processor (" 
sql_prefix += "prc_ts_facility,"   
sql_prefix += "prc_nm_machine,"   
sql_prefix += "prc_vl_facility,"   
sql_prefix += "prc_tp_unit,"
sql_prefix += "prc_ds_facility"
sql_prefix += ") VALUES ("
...
sql_insert += "'Mhz',"
sql_insert += "'Processor current frequence');"
sql_list.append(sql_insert)
#----------------------------------------------------------#
...
sql_insert += "'Mhz',"
sql_insert += "'Processor minimun frequence');"
sql_list.append(sql_insert)
#----------------------------------------------------------#
...
sql_insert += "'Mhz',"
sql_insert += "'Processor maximum frequence');"
sql_list.append(sql_insert)
#----------------------------------------------------------#
...
sql_insert += "'%',"
sql_insert += "'Processor usage percent');"
sql_list.append(sql_insert)
#----------------------------------------------------------#
sql_insert = ""
