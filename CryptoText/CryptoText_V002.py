...
btn_save = tk.Button(master=frm_text, text="         Save         ", command=cmd_save)
btn_save.grid(row=0, column=1, padx=5, pady=5, sticky="nsw")
btn_exit = tk.Button(master=frm_text, text="         Exit         ", command=cmd_exit)
btn_exit.grid(row=0, column=1, padx=5, pady=5, sticky="nse")
