...
# local-packages\Python311\Scripts
...
def file_write():
    ...
    for int_textcut in range(0, int_textlen, 117):
        CryptoText.int_parts += 1
        str_textpart = CryptoText.str_text[int_textcut:int_textcut + 117] 
