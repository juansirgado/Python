...
def cmd_login():
    set_variables()
    fernet_generate_key()
    check_user("local-storage/CryptoText" + CryptoText.str_sufix)
    ...
    file_read("local-storage/CryptoText" + CryptoText.str_sufix)
...
def cmd_delete():
    ...
    os.remove("local-storage/CryptoText" + CryptoText.str_sufix)
