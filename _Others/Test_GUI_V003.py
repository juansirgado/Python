...
#--------------------------------------------------------
# set path=%path%;C:\Users\JuanSirgadoyAntico\AppData\Local\Packages\PythonSoftwareFoundation.Python.3.11_qbz5n2kfra8p0\LocalCache\local-packages\Python311\Scripts
#--------------------------------------------------------
# pyinstaller --onefile Test_GUI_V003.py
#--------------------------------------------------------